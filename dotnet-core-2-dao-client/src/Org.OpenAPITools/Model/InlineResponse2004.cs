...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(Object descriptionColumns = default(Object), string id = default(string), Object labelColumns = default(Object), SubjectModelApiGet result = default(SubjectModelApiGet), List<string> showColumns = default(List<string>), string showTitle = default(string))
        {
        ...
        public SubjectModelApiGet Result { get; set; }
