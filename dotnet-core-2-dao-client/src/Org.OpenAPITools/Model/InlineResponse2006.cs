...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        public InlineResponse2006(Object descriptionColumns = default(Object), List<string> ids = default(List<string>), Object labelColumns = default(Object), List<string> listColumns = default(List<string>), string listTitle = default(string), List<string> orderColumns = default(List<string>), List<SubjectInfoModelApiGetList> result = default(List<SubjectInfoModelApiGetList>))
        {
        ...
        public List<SubjectInfoModelApiGetList> Result { get; set; }
